...
module.exports = function Config(opts){
  ...
  return {
    ...
    "organizationId": process.organization.id,
    "airnow": {
    ...
    "mqtt": {
      ...
      "mqttDataChannel": opts._.find(device.channels, 'channelTemplateName', 'sensor').channel,
      "mqttControlChannel": opts._.find(device.channels, 'channelTemplateName', 'control').channel,
      "mqttDeviceDataChannel": opts._.find(device.channels, 'channelTemplateName', 'device-log').channel
    }
  };
