...
const config = {
  ...
  account: {
    idmHost: process.env.XIVELY_IDM_HOST || 'id.xively.eu',
    integrationHost: process.env.XIVELY_INTEGRATION_HOST || 'integration.xively.eu',
    timeSeriesHost: process.env.XIVELY_TIMESERIES_HOST || 'timeseries.xively.eu',
    brokerHost: process.env.XIVELY_BROKER_HOST || 'broker.xively.eu',
    ...
    blueprintHost: process.env.XIVELY_BLUEPRINT_HOST || 'blueprint.xively.eu',
